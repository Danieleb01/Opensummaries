...
/**
 * Servlet che si occupa di servire richieste all'url /Risultati
 * @author Daniele
 */
@WebServlet(name = "Risultati", urlPatterns = {"/Risultati"})
public class Risultati extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        {
            req.getRequestDispatcher("Risultati-ricerca.html").forward(req, res);
        }
    }
}
